(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-solutions")) new swiper_core_Swiper(".swiper-solutions", {
    ...
    function borderRadiusFunction() {
        ...
        const applyCorners = () => {
            ...
            galleryItems.forEach((item, index) => {
                ...
                if (currentCol !== columns) item.style.borderRight = "none";
                if (currentRow !== rows) item.style.borderBottom = "none";
